...
/*
 ...
 why we use this SingleTone?
 Because to handle any fake data we need while testing productions, preview in canvas, .....
...
// A SingleTon Class to use in previewing data in a easy way.
